...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/../../IMKitSDK.framework"
  install_framework "$BUILT_PRODUCTS_DIR/JSONModel/JSONModel.framework"
  install_framework "$BUILT_PRODUCTS_DIR/LOAlertController/LOAlertController.framework"
  install_framework "$BUILT_PRODUCTS_DIR/LOUIKit/LOUIKit.framework"
